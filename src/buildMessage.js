...
const LOGO_URL = 'https://github.com/ptrckqn/valorant-discord-bot/blob/main/assets/valorant-logo.png?raw=true';
const RANKS_BASE_URL = 'https://github.com/ptrckqn/valorant-discord-bot/blob/main/assets/ranks';

const LINEBREAK = { name: '\u200B', value: '\u200B' };

const buildMessage = ({ command, data = {}, desc }) => {
  const { username, timePlayed, totalMatches, wins, losses, winLossPct, scorePerRound, kills, killsPerRound, deaths, assists, kdr, rank } = data;
